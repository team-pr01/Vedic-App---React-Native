...
const generateRecipe = async (prompt: string): Promise<Recipe> => {
  ...
  return {
    ...
    name: 'AI Generated Sattvic Bowl',
    category: 'sattvic',
    ingredients: [
      'Quinoa (1 cup)',
      ...
      {showWelcomePopup && (
        <View style={styles.welcomeOverlay}>
          <View style={styles.welcomePopup}>
            <Text style={styles.welcomeTitle}>Welcome to Vedic Food!</Text>
            <Text style={styles.welcomeMessage}>
              Explore traditional recipes or use our AI to generate new ones based on your preferences.
            </Text>
            <TouchableOpacity
              onPress={() => {
                triggerHaptic();
